  ...
  return (
    <>
      {!session ? (
          ...
          <LayoutWrapper>
            ...
            <RightColumn>
              <RightColumnContentWrapper>
                <h2 tw="text-xl sm:text-4xl font-bold text-pink-300 text-center whitespace-nowrap text-slate-900">
                  Anmelden
                </h2>
        ...
        <div tw="flex flex-col justify-center items-center h-screen w-screen">
          <LoadingSpinner />
          <Paragraph text={`Are you ready to mumble?`} color="dark" size="default" alignment="center" />
        </div>
      )}
    </>
  );
