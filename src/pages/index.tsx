...
import { QwackerUserResponse, fetchMumbles, fetchUsers } from '@/services';
...
export default function Page({
  ...
  return (
    <>
      ...
      <Stream url="/api/mumbles" limit={limit} fallback={fallback} fetcher={fetchMumbles} fallbackUsers={fallbackUsers} />
    </>
  );
}
